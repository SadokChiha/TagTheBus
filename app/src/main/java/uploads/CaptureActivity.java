...
public class CaptureActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        System.out.println("sadok0");

              id= Integer.parseInt(i.getStringExtra("s"));
Toast.makeText(this.getApplicationContext(),"id recu "+id,Toast.LENGTH_SHORT).show();
        System.out.println("sadok01");
        //  System.out.println("wsol "+station.getStreet_name());
